...
$product_name = "ROBOTICS;NOTES DaSH Improvement Patch (Steam)"
...
New-Item -ItemType directory -Path .\"DIST\NOTES DaSH" | Out-Null
Move-Item .\DIST\*.dll .\DIST\"NOTES DaSH"\
# Reported necessary for some users, otherwise:
# "Procedure entry point csri_renderer_default could not be located in ...\NOTES DaSH\DINPUT8.dll"
Copy-Item .\DIST\"NOTES DaSH"\VSFilter.dll .\DIST\
...
#{
#    $patches = gci .\rnd-script-patches\$($script.Name).*.vcdiff | Sort
...
git pull
cd ..
#Get-ChildItem rnd-scripts-git -filter *.txt -Recurse | Copy -Destination rnd-scripts
.\sc3tools\target\release\sc3tools.exe replace-text temp\patched_script_archive\*.msb rnd-scripts\*.txt rnd
...
# DXVK
Move-Item .\DIST\d3d9 ".\DIST\NOTES DaSH"
Move-Item .\DIST\d3d10 ".\DIST\NOTES DaSH"
Move-Item .\DIST\d3d10_1 ".\DIST\NOTES DaSH"
Move-Item .\DIST\d3d10core ".\DIST\NOTES DaSH"
Move-Item .\DIST\d3d11 ".\DIST\NOTES DaSH"
Move-Item .\DIST\dxgi ".\DIST\NOTES DaSH"
...
Get-ChildItem .\rnd-edited-images\*.* -Recurse | Copy -Destination .\DIST\languagebarrier\c0data
...
PrintSection "Packing installer"
cd temp
$patchFolderName = "RNDPatch-v$version_string-Setup"
...
Move-Item -Force .\noidget.exe .\RNDPatch-Installer.exe
cd ..\..\DIST
